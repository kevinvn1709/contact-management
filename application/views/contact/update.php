            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone_work" class="form-control mask_phone">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-mobile-phone"></i></span>
                        <input type="text" name="phone_mobile" class="form-control mask_phone">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="email_work" class="form-control mask_email">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                        <input type="text" name="email" class="form-control mask_email">
